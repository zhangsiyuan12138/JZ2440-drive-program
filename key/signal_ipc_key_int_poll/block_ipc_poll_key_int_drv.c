...
{
    major = register_chrdev(0,"block_ipc_poll_key",&key_drv_mode);  //  /proc/devices

	key_int_class = class_create(THIS_MODULE,"key_int_class");
	key_int_class_device = class_device_create(key_int_class,NULL,MKDEV(major,0),NULL,"block_ipc_poll_key");  //    /dev/key_int_drv
...
{
   unregister_chrdev(major,"block_ipc_poll_key");
